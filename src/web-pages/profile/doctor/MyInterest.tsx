...
const MyInterest = ({ myProfile }: TProps) => {
                  ...
                  <div className="col-span-12 md:col-span-7 p-2">
                        ...
                        <div className="my-4 space-y-5">
                              ...
                              <p className="text-primaryText">
                                    amet, ex Ut adipiscing sodales. massa placerat. Sed eget fringilla gravida nisi
                                    Donec eu eu tempor nulla, nulla, leo. faucibus tortor. Donec libero, elementum
                                    tincidunt id tincidunt dui faucibus turpis consectetur amet, nibh luctus nibh lacus,
                                    ex hendrerit fringilla fringilla est. lacus Nunc tincidunt dignissim, id nec Lorem
                                    dui Sed nibh id elementum non tincidunt
                              </p>
                        </div>
                  </div>
                                    ...
                                    <div className="p-4">
                                          ...
                                          <div className="flex items-center gap-5">
                                                <Image
                                                      ...
                                                      alt="Doctor"
                                                />
                                                <h3 className="text-xl font-semibold text-headerText">
