const NotificationDropdown = () => {
    return (
        <div className="w-[400px] h-fit mx-auto rounded-lg bg-white shadow-sm overflow-hidden  p-5">
                ...
                {[...Array(5)].map((notification, index) => (
                    <div key={index} className="flex items-center w-full space-y-2 mb-2">
                        <div className="flex flex-col w-full p-3 rounded-md shadow-md">
                            <h1 className=" text-primaryText font-semibold">Notification topic</h1>
