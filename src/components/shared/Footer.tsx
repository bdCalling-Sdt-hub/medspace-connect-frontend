                ...
                <div className="text-center md:text-start">
                    ...
                    <div className="flex space-x-4">
                        {socialLinks.map((item, index) => (
                            ...
                            >
                                <Image width={32} height={32} src={item.src} alt="social media icon" />
                            </a>
                        ))}
                    </div>
                </div>
