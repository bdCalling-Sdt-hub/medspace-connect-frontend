    ...
    return (
        <div className="w-[263px] min-h-[226px] mx-auto bg-white shadow-md rounded-lg overflow-hidden ml-5 pb-2">
            ...
            <div className="text-center mt-4">
                <Link className="flex flex-col justify-center items-center mx-auto" href={'/profile'}>
                    <Button
                        style={{
                            border: 'none',
                            height: 30,
            ...
            {/* Log Out Section */}
            <div className="flex justify-start gap-4 cursor-pointer items-center px-6 py-2">
                <svg width={15} height={15} viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path
                        ...
                        strokeLinejoin="round"
                    />
                    <path d="M13.125 7.5H5.625" stroke="#6B6B6B" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
